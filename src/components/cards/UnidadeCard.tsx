...
export function UnidadeCard({ unidade, className, variant = 'grid', onEdit, onView }: UnidadeCardProps) {
  ...
  if (variant === 'list') {
    return (
      <div className={cn(
        'bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all duration-300 p-4',
        className
      )}>
  ...
  return (
    <div className={cn(
      'bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all duration-300 p-5',
      className
    )}>
      {/* Header */}
